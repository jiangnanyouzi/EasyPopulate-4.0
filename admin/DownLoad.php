...
class DownLoad {
    ...
    public function process($download_config) {
        ...
        foreach ($download_config as $k => $config) {
            ...
            curl_setopt($ch[$k], CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36');
            curl_setopt($ch[$k], CURLOPT_TIMEOUT, $this->timeout);
            curl_setopt($ch[$k], CURLOPT_CONNECTTIMEOUT, $this->timeout);
